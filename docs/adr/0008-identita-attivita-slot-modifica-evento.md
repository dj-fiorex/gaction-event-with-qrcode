...
- Chi perde un'Attività **non viene avvisato** e può presentarsi per qualcosa che non c'è più. Verso l'Utente non esiste un canale oltre al [[Reinvio dell'email dei biglietti]], che è manuale. Limite noto, non svista.
